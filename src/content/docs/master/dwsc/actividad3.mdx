...
1. Creamos la entidad User
   ...
   <Aside>
     Utilizamos `@Getter` y `@Setter` de Lombok para generar los métodos getter
     y setter automáticamente.
   </Aside>
...
3. Comprobación del archivo WADL
   ...
   <Image src={wadlImage} alt="WADL Application Documentation" loading="lazy" />
...
4. Comprobación de distintos servicios.
   ...
   <Image src={usersImage} alt="Users Documentation" loading="lazy" />
