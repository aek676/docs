...
export const defaultTabsRoutes = `
{
  path: '',
...
- **Formulario de Reserva**: Página accesible desde la pestaña de reservas. Contiene un
  ...
  <Image
    src={ReservationFormImg}
    alt="Formulario de reserva"
    width={330}
    style="display: block; margin: 1rem auto 0;"
  />
